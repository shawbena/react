! function(t, n) {
    ...
    return function(t) {
        ...
        n.addLeadingSlash = function(t) {
            ...
            var i = n.indexOf("?");
            return i !== -1 && (e = n.substr(i), n = n.substr(0, i)), n = decodeURI(n), {
                pathname: n,
                search: "?" === e ? "" : e,
                hash: "#" === o ? "" : o
            }
        ...
        n.createLocation = function(t, n, e, o) {
            var i = void 0;
            return "string" == typeof t ? (i = (0, s.parsePath)(t), i.state = n) : (i = r({}, t), void 0 === i.pathname && (i.pathname = ""), i.search ? "?" !== i.search.charAt(0) && (i.search = "?" + i.search) : i.search = "", i.hash ? "#" !== i.hash.charAt(0) && (i.hash = "#" + i.hash) : i.hash = "", void 0 !== n && void 0 === i.state && (i.state = n)), i.key = e, o && (i.pathname ? "/" !== i.pathname.charAt(0) && (i.pathname = (0, a.default)(i.pathname, o.pathname)) : i.pathname = o.pathname), i
                ...
                var n = window.history,
                    ...
                    P = function(t) {
                        var n = t || {},
                            ...
                            u = i.hash,
                            f = a + c + u;
                        return w && (f = (0, s.stripPrefix)(f, w)), r({}, (0, s.parsePath)(f), {
                            state: o,
                            key: e
                        })
                    },
                    ...
                    I = 0,
                    q = function(t) {
                        I += t, 1 === I ? ((0, d.addEventListener)(window, h, L), o && (0, d.addEventListener)(window, v, S)) : 0 === I && ((0, d.removeEventListener)(window, h, L), o && (0, d.removeEventListener)(window, v, S))
                    },
                    B = !1,
                    F = function() {
                        var t = arguments.length > 0 && void 0 !== arguments[0] && arguments[0],
        ...
        var r = ("function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(t) {
            ...
            l = function() {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                    ...
                    h = (0, s.default)(),
                    v = function(t) {
                        r(A, t), A.length = A.entries.length, h.notifyListeners(A.location, A.action)
                    },
                    p = function() {
                    ...
                    y = f(u, 0, o.length - 1),
                    g = o.map(function(t) {
                        return "string" == typeof t ? (0, c.createLocation)(t, void 0, p()) : (0, c.createLocation)(t, void 0, t.key || p())
                    }),
                    m = a.createPath,
                    w = function(t, e) {
                        var o = "PUSH",
                        ...
                        h.confirmTransitionTo(r, o, n, function(t) {
                            if (t) {
                                var n = A.index,
                                    e = n + 1,
                                    i = A.entries.slice(0);
                                i.length > e ? i.splice(e, i.length - e, r) : i.push(r), v({
                                    action: o,
                                    location: r,
                                    index: e,
                                    entries: i
        ...
        var e = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(t) {
            ...
            o = function t(n, o) {
                ...
                if (Array.isArray(n)) return !(!Array.isArray(o) || n.length !== o.length) && n.every(function(n, e) {
                    return t(n, o[e])
                });
                ...
                if ("object" === r) {
                    ...
                    var u = Object.keys(n),
                        s = Object.keys(o);
                    return u.length === s.length && u.every(function(e) {
                        return t(n[e], o[e])
                    })
                }
                return !1
