define(['exports', './react', './react-dom'], function (exports, _react, _reactDom) {
    ...
    function popo(title) {
        var TipPop = function TipPop(props) {
        ...
        _reactDom2.default.render(_react2.default.createElement(TipPop, { message: title }), document.getElementById('pop'));
    }
    var queryString = {
