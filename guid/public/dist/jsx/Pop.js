define(['exports', '../react', '../utli'], function (exports, _react, _utli) {
    ...
    var Pop = function (_React$Component) {
        ...
        function Pop(props) {
            ...
            _this.closePopHandler = function (e) {
    ...
    var NewRolePop = function (_React$Component2) {
        ...
        function NewRolePop(props) {
            ...
            _this2.createRoleHandler = function (e) {
                _this2.setState({ roleName: 'new role name' });
                _utli2.default.ajax({
                    method: 'post',
                    url: '/role/newRole',
                    data: {
                        roleName: _this2.state.roleName
                    }
                }, function (res) {
